...
public class gameController implements Initializable {
    ...
    public void generatefgClicked(ActionEvent actionEvent) {
        ...
        if(isFirst) {
           ...
           // firstgField.setText("5000");
            firstgField.setText(firstGuess);
            //testResultList = getResult(testsNumber, stringTransform("5000"));
       ...
       // System.out.println("Strike: " + testResultList.get(0) + "\tHit: " + testResultList.get(1) + "\tMiss: " + testResultList.get(2));
        // Increase steps
        stepsNumber++;
        // Load table to show result in UI
...
//            int strikes = 0;
//            int hits = 0;
//            List<Integer> secret = stringTransform(holder.get(i));
//            List<Integer> guess = stringTransform(currentGuess);
//            for (j = 0; j < guess.size(); j++) {
//                if (contains(secret,guess.get(j))) {
//                    if (guess.get(j) == secret.get(j)) {
//                        strikes++;
//                    } else {
//                        hits++;
//                    }
...
//            }
          ...
          //    if(result.get(0).equals(strikes) && result.get(1).equals(hits)) {
...
//    public static boolean contains(List<Integer> array, final int v) {
